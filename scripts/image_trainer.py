...
async def main():
    ...
    # Create config file
    config_path = create_config(args.task_id, model_path, args.model_type, args.expected_repo_name, args.trigger_word)

    print("Preparing dataset...", flush=True)
    training_images_repeat = (
        cst.DIFFUSION_SDXL_REPEATS if args.model_type == ImageModelType.SDXL.value else cst.DIFFUSION_FLUX_REPEATS
    )
    prepare_dataset(
